/*
    use for kernel switch to user mode
*/
use super::eret_to_user;
use crate::{
...
impl Index<RegType> for UserCtx {
    type Output = u64;
...
impl IndexMut<RegType> for UserCtx {
...
impl UserCtx {
    ...
    pub fn user_init(&mut self, stack: UserAddr, pc: UserAddr) {
        ...
        println!("user_conctx:init: pc:{:#x}", pc.addr());
    }
}
...
pub fn switch_to_user(addr: KernelAddr) {
    unsafe {
        eret_to_user(addr.addr());
    }
}
