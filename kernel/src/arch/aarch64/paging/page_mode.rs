...
impl PageMode for ARM64 {
    ...
    fn visit_levels_until(level: PageLevel) -> &'static [PageLevel] {
        match level.0 {
            0 => &[PageLevel(3),PageLevel(2), PageLevel(1), PageLevel(0)],
            1 => &[PageLevel(3),PageLevel(2), PageLevel(1)],
            2 => &[PageLevel(3),PageLevel(2)],
            3 => &[PageLevel(3)],
